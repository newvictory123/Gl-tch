...
namespace UnityEngine.ProBuilder.Csgreal
{
    /// <summary>
    ...
    public class Plane
    {
        ...
        public void SplitPolygon(Polygon polygon, List<Polygon> coplanarFront, List<Polygon> coplanarBack, List<Polygon> front, List<Polygon> back)
        {
            ...
            for (int i = 0; i < polygon.vertices.Count; i++)
            {
                ...
                EPolygonType type = (t < -CSGreal.epsilon) ? EPolygonType.Back : ((t > CSGreal.epsilon) ? EPolygonType.Front : EPolygonType.Coplanar);
                polygonType |= type;
                types.Add(type);
            }
